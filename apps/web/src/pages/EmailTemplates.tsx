...
const mergeTags = [
  { tag: '{{companyName}}', label: 'Company', categories: ['estimate', 'change_order', 'invoice', 'drip', 'review', 'system'] },
  { tag: '{{companyLogoUrl}}', label: 'Logo URL', categories: ['invoice'] },
  { tag: '{{leadName}}', label: 'Customer', categories: ['estimate', 'change_order', 'invoice', 'drip', 'review', 'system'] },
  ...
  { tag: '{{estimatorName}}', label: 'Estimator', categories: ['estimate', 'change_order', 'invoice', 'drip', 'review', 'system'] },
  { tag: '{{estimatorEmail}}', label: 'Estimator email', categories: ['estimate', 'change_order', 'invoice', 'drip', 'review', 'system'] },
  { tag: '{{estimatorPhone}}', label: 'Estimator phone', categories: ['estimate', 'change_order', 'invoice', 'drip', 'review', 'system'] },
  { tag: '{{jobName}}', label: 'Job', categories: ['change_order', 'invoice'] },
  { tag: '{{jobAddress}}', label: 'Jobsite', categories: ['change_order', 'invoice'] },
  ...
  { tag: '{{paymentSchedule}}', label: 'Payment schedule', categories: ['change_order'] },
  { tag: '{{portalUrl}}', label: 'Portal link', categories: ['change_order', 'invoice'] },
  { tag: '{{invoiceNumber}}', label: 'Invoice number', categories: ['invoice'] },
  { tag: '{{invoiceDescription}}', label: 'Invoice description', categories: ['invoice'] },
  { tag: '{{invoiceAmount}}', label: 'Invoice amount', categories: ['invoice'] },
  { tag: '{{paymentAmount}}', label: 'Payment amount', categories: ['invoice'] },
  { tag: '{{balanceDue}}', label: 'Balance due', categories: ['invoice'] },
  { tag: '{{paymentSource}}', label: 'Payment method', categories: ['invoice'] },
  { tag: '{{dueLabel}}', label: 'Due label', categories: ['invoice'] },
  { tag: '{{ctaText}}', label: 'CTA text', categories: ['estimate', 'change_order', 'invoice'] },
];

const previewData: Record<string, string> = {
  companyName: 'Golden Brush Painting',
  companyLogoUrl: 'https://crewmodo-dev.pages.dev/icon.svg',
  leadName: 'Emily Rivera',
  total: '8,740',
  estimatorName: 'Nick Martinez',
  estimatorEmail: 'nick@goldenbrush.example',
  estimatorPhone: '(415) 555-0138',
  proposalUrl: 'https://crewmodo-dev.pages.dev/estimates/demo-preview',
  ...
  amount: '640',
  paymentDue: '320',
  portalUrl: 'https://crewmodo-dev.pages.dev/portal/demo-change-order',
  invoiceNumber: 'DEP-20260603-1842',
  invoiceDescription: 'Deposit invoice for Rivera Interior Repaint',
  invoiceAmount: '$4,370.00',
  paymentAmount: '$4,370.00',
  balanceDue: '$0.00',
  paymentSource: 'Card',
  dueLabel: 'Due now to reserve schedule',
